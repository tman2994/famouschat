...
//  famouschat
//
//  Created by Oni Angel on 18/11/2018.
...
public extension UIWindow {
    ...
    public func setRootViewController(_ controller: UIViewController, options: TransitionOptions = TransitionOptions()) -> UIViewController {
