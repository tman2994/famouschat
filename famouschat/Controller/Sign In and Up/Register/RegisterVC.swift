...
class RegisterVC: UIViewController, NVActivityIndicatorViewable {
    ...
    func init_UI()
    {
        ...
        backBtn.tintColor = Utility.color(withHexString: ShareData.btn_color)
    ...
    @IBAction func nextAction(_ sender: Any) {
        ...
        {
            CommonFuncs().doneAlert(ShareData.appTitle, "Error email format", "CLOSE", {})
        }
            ...
            CommonFuncs().createRequest(true, "signup", "POST", parmeters, completionHandler: {data in
                ...
                DispatchQueue.main.async {
                    ...
                    if status
                    {
                        ...
                        self.verify_in = CommonFuncs().inputAlert(ShareData.appTitle, "Please check your email", "Verify code...", 2, ["VERIFY", "CANCEL"], [Utility.color(withHexString: ShareData.btn_color), UIColor.gray], [UIColor.white, UIColor.white], self, [#selector(self.verify(_:)), #selector(self.verifyCancel(_:))])
