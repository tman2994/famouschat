        ...
        if ShareData.book_detail_from_status
        {
            ...
            QuickBloxHelper.sharedInstance.getUserByExterNalId(id) { (isSucess, oponentId) in
                if isSucess {
                    ...
                    QuickBloxHelper.sharedInstance.makeCall(toQBId: oponentId, hintText: "Hello \(ShareData.selected_book.profile.name!)", tutorId: "1234", videoCallId: ShareData.selected_book.book.id!)
