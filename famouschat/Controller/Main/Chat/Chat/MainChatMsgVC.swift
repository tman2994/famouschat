...
class MainChatMsgVC: UIViewController, NVActivityIndicatorViewable {
    ...
    func init_UI()
    {
        ...
        photo.layer.borderColor = UIColor.init(red: 85/255, green: 155/255, blue: 255/255, alpha: 0.3).cgColor
                ...
                DispatchQueue.main.async {
                    if allowed {
                        ...
                        AVAudioSession.sharedInstance().requestRecordPermission({ (granted) -> Void in
                            ...
                            if !granted {
                                let microphoneAccessAlert = UIAlertController(title: "Populere", message: "Microphone permission access is not granted. Please allow from setting", preferredStyle: UIAlertController.Style.alert)
